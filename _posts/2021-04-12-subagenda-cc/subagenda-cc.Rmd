...
# Subagenda Cambio Climático y Sargazo
 ...
 La subagenda de Cambio Climático y Sargazo es parte de la Agenda Ecológica que Coordina **Héctor A. Lizárraga Cubedo**, director del [Centro Ecológico Akumal](htpp://ceakumal.org).  El coordinador de esta subagenda es el **M. en C. Olmo Torres Talamantes**, quien actualmente es Director de Razonatura [Razonatura](http://razonatura.org).
...
```{r CoordinadorCC, echo=FALSE, warning=FALSE,message=FALSE, fig.show="hold", fig.cap="Coordinador de Cambio Climático y Sargazo de la Agenda Ecológica", out.width='50%', fig.align='center', results = 'asis'}
library(knitr)
library(here)
library(grid)
library(png)
...
- Gladys Perez de la Fuente,	Red PROPLAYAS
...
```{r TallerCC2, echo=FALSE, warning=FALSE,message=FALSE, fig.show="hold", fig.cap="Segundo taller de Cambio Climático y Sargazo de la Agenda Ecológica", out.width='60%', fig.align='center', results = 'asis'}
library(knitr)
library(here)
...
```{r TallerCC2.1, echo=FALSE, warning=FALSE,message=FALSE, fig.show="hold", fig.cap="Evidencia del segundo taller de Cambio Climático y Sargazo de la Agenda Ecológica", out.width='60%', fig.align='center', results = 'asis'}
library(knitr)
library(here)
...
Rosaura Cuevas Villar, presentó la iniciativa impulsada por GIZ, SEMARNAT, CONANP, SECTUR, e INECC, denominada "ADAPTUR", que tiene por objetivo el apoyar al Sector turismo para Adaptarse al Cambio Climático. Esta iniciativa tiene entre sus objetivos:
 ...
 - Apoyar en reducir el riesgo de negocio e las empresas turísticas (vulnerabilidad);
...
```{r TallerCC2.2, echo=FALSE, warning=FALSE,message=FALSE, fig.show="hold", fig.cap="Presentación de la iniciativa ADAPTUR", out.width='60%', fig.align='center', results = 'asis'}
library(knitr)
library(here)
...
```{r TallerCC2.3, echo=FALSE, warning=FALSE,message=FALSE, fig.show="hold", fig.cap="Pesentación de l a iniciativa SUSTENTUR", out.width='60%', fig.align='center', results = 'asis'}
library(knitr)
library(here)
...
De la iniciativa resalta conocer cuáles son los impactos que esta generando el sector turístico en relación al cambio climático, consideando factores como la visitación, transporte a los destinos turísticos, comportamiento del turista, nformación que se le brinda y la huella ecológica que esta actividad genera. Todo lo anterior desde la perspectiva de insumos para una mas eficiente estretagia de cambio climático para este sector.
