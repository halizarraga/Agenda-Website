...
# Subagenda Áreas Naturales Protegidas
 ...
 La subagenda de Áreas Naturales Protegidas es parte de la Agenda Ecológica que Coordina **Héctor A. Lizárraga Cubedo**, director del [Centro Ecológico Akumal](htpp://ceakumal.org).  El coordinador de esta subagenda es el **M. en C. Gonzalo Merediz Alonso**, quien actualmente es Director de Amigos de Sian ka 'an [Amigos de Sian Kann](https://www.amigosdesiankaan.org).
...
El comanejo aunque esta contemplado en la ley no sea impulsado apropiadamente pero podría ser una muy buena opción. Para ello es importante una mejor comunicación con las comunidades para que conozcan la importancia de las ANPs.

Los Ordenamientos aunque suponen un compromiso entre el gobierno y socieda no han dimensionado eficientemente el tema de la conectividad, los objetos de cosnervación  y no permiten impulsar en decreto de las ANPs. 

El tema de la Reserva hidrgeológica del Norte del Estado que se propuso originalmente en 2008, tal vez no sea un tema a impulsar en el corto plazo, de acuerdo a los presentes, ya que se requiere mayor información sbre los beneficios que este esquema de conservación implica, sobretodo en la falta de esquemas de financiamiento o incentivos fiscales.
...
```{r TallerANP2, echo=FALSE, warning=FALSE,message=FALSE, fig.align='center',fig.cap="Primer taller de Áreas Naturales Protegidas de la Agenda Ecológica", results = 'asis'}
library(knitr)
library(here)
...
En este taller Héctor Lizárraga compartió la información disponible pública sobre las ANPs decretadas en el municipio, de carácter públicas, con información sobre nombre y categoría del ANP, fecha de decreto, superficie, si cuenta con Programa de Manejo, si cuenta con categorías especiales como Sitio Ramsar o Patrimonio de la Humanidad. Y se trató la posibilidad de promover el establecimiento de Áreas Voluntarias de Conservación privadas o Ejidales. ara el municiio este último esquema, con gran potencial, no ha sido impulsado.



También se consultó las **"MEMORIAS DEL TALLER PARA CONSOLIDAR LA RED DE ÁREAS VOLUNTARIAS DE CONSERVACIÓN EN LA PENÍNSULA DE YUCATÁN (https://www.biodiversidad.gob.mx/corredor/pdf/PROFORCO/36-Memoria-Chetumal.pdf"**. En dicho documento se promueve ka red de Áreas de Conserevación privadas o ejidales, resaltando que estos ejercicios han sido posibles en municipios como Othón P. Blanco, José maría Morelos y Felipe Carrillo Puerto, en Quintana Roo. En Tulum NO existe ninguna área de conservación de éste tipo.
...
Propuesta de acción en ANP, posiblemente impusar algún ANP, sobre todo en conservación de agua.

En Pta Allen, se eta dotando de un sistema solar. El Mpio se tiene que sumar. Se requiere de liderazgo del mpio y sumarse a una estructura de gobernanza, ejemplo de manejo comunitario.

Posiblemente no impulsar la reserva HG tal vez no propuesta como fue originalmente propuesta.

Platicar mas sobre los incentivos fiscales, mpio y congreso del edo. Con la sema ver los mecanismos de incentivos fiscales para desarrollar. Posiblemente ver los impuestosu otros mecanismos de recaudación.
...
Programa de reubicación de árboles de la carretera.

Ser cuidadosos en presentar nuevas propuestas de ANPs, trabajar mas en una estrategia.

Proponer los esquemas privados de conservación. No hay un programa de largo plazo de incentivo de pagos.

Imlupsar la conservación de los valores naturales.

Pasos de fauna, considerarlos en la Agenda no solo en el contexto del proyecto del tren Maya.
